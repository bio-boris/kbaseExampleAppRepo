...
from bsadkhinContigFilterApp1.bsadkhinContigFilterApp1Impl import bsadkhinContigFilterApp1
from bsadkhinContigFilterApp1.bsadkhinContigFilterApp1Server import MethodContext
from bsadkhinContigFilterApp1.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class bsadkhinContigFilterApp1Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('bsadkhinContigFilterApp1'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'bsadkhinContigFilterApp1',
        ...
        cls.serviceImpl = bsadkhinContigFilterApp1(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_bsadkhinContigFilterApp1_" + str(suffix)
